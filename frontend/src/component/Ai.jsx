...
import open from "../assets/ai.mp3"
...
function Ai() {
  ...
  let [activeAi,setActiveAi] =useState()
  ...
  recognition.onresult =(e)=>{
    ...
    else if(transcript.toLowerCase().includes("collection") || transcript.toLowerCase().includes("product") || transcript.toLowerCase().includes("products")){
  ...
  return (
    <div className='fixed lg:bottom-[10px] md:bottom-[40px] bottom-[80px] left-[2%]' onClick={()=>{recognition.start();
      openingSound.play()
      setActiveAi(true)
